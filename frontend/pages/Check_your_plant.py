...
plant_icon_path = os.path.join( "images", "detect_plant.png")
...
plants_disease_icon_path = os.path.join( "images", "plants_disease_types.png")
...
check_icon_path = os.path.join( "images", "plant_icon.png")
...
rejected_image_path = os.path.join( "images", "rejected_sample_check.jpg")  
with open(rejected_image_path, "rb") as f:
    rejected_image_base64 = base64.b64encode(f.read()).decode()
accepted_image_path = os.path.join( "images", "accepted_sample_check.jpg")
