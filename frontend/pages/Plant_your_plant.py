...
plant_icon_path = os.path.join( "images", "plant_guide.png")
...
soil_icon_path = os.path.join( "images", "soil_types.png")
...
check_icon_path = os.path.join( "images", "soil_icon.png")
...
rejected_image_path = os.path.join( "images", "rejected_sample_plant.jpg")  
with open(rejected_image_path, "rb") as f:
    rejected_image_base64 = base64.b64encode(f.read()).decode()
accepted_image_path = os.path.join( "images", "accepted_sample_plant.jpg")
        ...
        with st.spinner("جارٍ تحليل التربة..."):
            ...
            if response.status_code == 200:
                ...
                recommendations_data = [
                   {"soil": "تربة طميية","plant": "الريحان الزينة، المريمية، اللافندر، نعناع، بقدونس، كزبرة، طماطم شيري","soil_tip": "أضف كمبوست طبيعي كل شهر","plant_tip": "احرص على تقليم الأوراق بشكل دوري ولا تفرط في الري."},
                   {"soil": "تربة حمراء","plant": "الجهنمية، نبات الياسمين، روزماري، زعتر، أوراق الكاري","soil_tip": "اخلطها بالكمبوست والملش لتحسين الخصوبة","plant_tip": "اسقِ النبات بانتظام ووفّر له ساعات كافية من ضوء الشمس المباشر."},
                   {"soil": "تربة طينية","plant": "الكالاديوم، نبات السرخس، الكرفس، النعناع المائي، الخس","soil_tip": "اخلط معها بيرلايت أو رمل لتحسين التصريف","plant_tip": "افحص التربة قبل الري وتجنّب تجمع الماء حول الجذور."},
                   {"soil": "تربة سوداء","plant": "نبتة الثعبان، الصبار الزينة، نبات المطاط، الريحان، الفلفل الحار الصغير، البقدونس","soil_tip": "أضف بيرلايت وكمبوست للحفاظ على توازن التصريف","plant_tip": "ضع النبات في إناء به صرف جيد، وقلل الري في الشتاء."},
                   {"soil": "تربة فيضية","plant": "نبات الشفليرا، النعناع الزينة، النعناع، الملوخية، الجرجير، الطماطم الشيري","soil_tip": "أضف رمل بنسبة بسيطة لتحسين التصريف","plant_tip": "احرص على تهوية التربة دوريًا وتخفيف كثافة الزراعة لتجنب التعفن."},
                   {"soil": "تربة رملية","plant": "الألوفيرا، الصبار، الروز ماري، الجرجير، الفجل، البصل الأخضر، زعتر","soil_tip": "أضف طبقة كمبوست خفيفة مع ري معتدل","plant_tip": "ازرع في مكان مشمس ولا تسقِ النبات إلا بعد جفاف التربة تمامًا."}
                ]
